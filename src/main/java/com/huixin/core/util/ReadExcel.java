...
import com.huixin.core.util.WDWUtil;
...
public class ReadExcel {
   ...
   * @return
   */
  public List<Stock> getExcelInfo(String fileName,MultipartFile Mfile){
   ...
   * @throws IOException
   */
  public  List<Stock> getExcelInfo(InputStream is,boolean isExcel2003){
